...
export default function SocialPostsDashboard() {
  ...
  const [generatedData, setGeneratedData] = useState<
    null | Record<PlatformKey, SocialPost[]>
  >(null);
  ...
  const handleGenerate = async () => {
    ...
    // Allow link for any project type, no restrictions
    ...
    try {
      ...
      const errorMessage =
        error?.response?.data?.error || error?.message || "Failed to generate posts";
      ...
      return (
        <div className="space-y-6">
          <div className="flex items-center gap-3">
            <div
              className={`w-10 h-10 rounded-full ${platformData.iconBg} flex items-center justify-center`}
            >
        ...
        <div className="grid gap-6 grid-cols-1 md:grid-cols-2">
          {posts.map((post, index) => {
            ...
            return (
              <Card
                key={postId}
                className="bg-zinc-900 border-t-4 border-l-0 border-r-0 border-b-0 overflow-hidden min-h-[280px] flex flex-col"
                style={{
                  borderTopColor:
                    platformData.key === "twitter"
                      ? "#3B82F6"
                      : platformData.key === "linkedin"
                      ? "#2563EB"
                      : "#EC4899",
                }}
              >
                <div className="p-6 space-y-4 flex flex-col flex-1">
                  <div className="flex items-start gap-3">
                    <div
                      className={`w-10 h-10 rounded-full ${platformData.iconBg} flex items-center justify-center flex-shrink-0`}
                    >
                      <Icon className="w-5 h-5 text-white" />
                    </div>
      ...
      <div className="container mx-auto px-4 py-12 space-y-10 max-w-7xl">
        <div className="text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 text-blue-400 mb-2">
            ...
            <span className="text-sm font-medium">
              Personalized AI Social Media Post Generator
            </span>
          </div>
          <h1 className="text-5xl font-bold tracking-tight">
            Personalized AI Post Generator
          </h1>
          <p className="text-gray-400 text-xl max-w-2xl mx-auto">
            Create tailored social media content for Twitter, LinkedIn, and Instagram
            with AI
          </p>
        </div>
        ...
        <Card className="p-6 bg-zinc-900/50 border-zinc-800">
          <div className="space-y-2 mb-6">
            ...
            <p className="text-gray-400">
              Enter your project details to generate optimized posts for all platforms
            </p>
          </div>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent className="bg-black border-zinc-800">
                    <SelectItem value="working" className="text-white hover:bg-zinc-800 focus:bg-zinc-800">
                      Working
                    </SelectItem>
                    <SelectItem value="completed" className="text-white hover:bg-zinc-800 focus:bg-zinc-800">
                      Completed
                    </SelectItem>
                    <SelectItem value="ongoing" className="text-white hover:bg-zinc-800 focus:bg-zinc-800">
                      Ongoing
                    </SelectItem>
                    <SelectItem value="launched" className="text-white hover:bg-zinc-800 focus:bg-zinc-800">
                      Launched
                    </SelectItem>
                    <SelectItem value="beta" className="text-white hover:bg-zinc-800 focus:bg-zinc-800">
                      Beta
                    </SelectItem>
                  </SelectContent>
                </Select>
            ...
            <div className="space-y-2">
              <Label htmlFor="todayFeature" className="text-white">
                Today&apos;s Feature *
              </Label>
              <Select value={todayFeature} onValueChange={setTodayFeature}>
                ...
                <SelectContent className="bg-black border-zinc-800">
                  <SelectItem value="authentication" className="text-white hover:bg-zinc-800 focus:bg-zinc-800">
                    Authentication
                  </SelectItem>
                  <SelectItem value="responsive-design" className="text-white hover:bg-zinc-800 focus:bg-zinc-800">
                    Responsive Design
                  </SelectItem>
                  <SelectItem value="api-integration" className="text-white hover:bg-zinc-800 focus:bg-zinc-800">
                    API Integration
                  </SelectItem>
                  <SelectItem value="database-setup" className="text-white hover:bg-zinc-800 focus:bg-zinc-800">
                    Database Setup
                  </SelectItem>
                  <SelectItem value="payment-integration" className="text-white hover:bg-zinc-800 focus:bg-zinc-800">
                    Payment Integration
                  </SelectItem>
                  <SelectItem value="search-functionality" className="text-white hover:bg-zinc-800 focus:bg-zinc-800">
                    Search Functionality
                  </SelectItem>
                  <SelectItem value="user-dashboard" className="text-white hover:bg-zinc-800 focus:bg-zinc-800">
                    User Dashboard
                  </SelectItem>
                  <SelectItem value="performance-optimization" className="text-white hover:bg-zinc-800 focus:bg-zinc-800">
                    Performance Optimization
                  </SelectItem>
                  <SelectItem value="accessibility" className="text-white hover:bg-zinc-800 focus:bg-zinc-800">
                    Accessibility Features
                  </SelectItem>
                </SelectContent>
              </Select>
              <p className="text-xs text-gray-500">
                What did you work on today? This personalizes the copy.
              </p>
            </div>
        ...
        {generatedData && (
          <Tabs defaultValue="all" className="w-full">
            <TabsList className="grid w-full max-w-md mx-auto grid-cols-4 bg-black border border-zinc-800">
              <TabsTrigger
                value="all"
                className="data-[state=active]:bg-zinc-800 data-[state=active]:text-white text-gray-400"
              >
                All
              </TabsTrigger>
              <TabsTrigger
              ...
              <TabsTrigger
                value="instagram"
                className="data-[state=active]:bg-pink-500 data-[state=active]:text-white text-gray-400 flex items-center gap-2"
              >
            ...
            <TabsContent value="all" className="space-y-12 mt-8">
              {generatedData.twitter && (
                <PlatformSection platform="twitter" posts={generatedData.twitter} />
              )}
              {generatedData.linkedin && (
                <PlatformSection platform="linkedin" posts={generatedData.linkedin} />
              )}
              {generatedData.instagram && (
                <PlatformSection platform="instagram" posts={generatedData.instagram} />
              )}
            </TabsContent>
        ...
        {!generatedData && (
          <div className="text-center py-20">
            ...
            <p className="text-gray-400">
              Fill in the form above and click Generate Posts to create your social
              media content
            </p>
          </div>
        )}
